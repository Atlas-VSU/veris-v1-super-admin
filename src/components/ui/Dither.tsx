...
class RetroEffectImpl extends Effect {
  ...
  constructor({ colorNum = 4.0, pixelSize = 2.0 }: { colorNum?: number; pixelSize?: number } = {}) {
...
// wrapEffect reads the constructor's first parameter to type the component's props,
// so colorNum and pixelSize are now valid JSX props on RetroEffect.
